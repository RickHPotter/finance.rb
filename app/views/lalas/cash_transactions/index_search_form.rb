      ...
      div(class: "flex justify-between items-center gap-2") do
        ...
        div do
          div(class: "grid grid-cols-2 items-center justify-center w-full mx-auto") do
            ...
            span(class: "font-poetsen-one font-thin text-xs text-gray-500 dark:text-slate-400") { model_attribute(CashTransaction, :paid) }
            span(class: "font-poetsen-one font-thin text-xs text-gray-500 dark:text-slate-400") { model_attribute(CashTransaction, :not_paid) }
          end
        end
      end
