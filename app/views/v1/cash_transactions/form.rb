...
class Views::V1::CashTransactions::Form < Views::Base # rubocop:disable Metrics/ClassLength
        ...
        div(class: "grid grid-cols-1 lg:flex items-center justify-center gap-2 mx-auto") do
          ...
          if cash_transaction.can_be_destroyed?
            LinkWithConfirmation(
              ...
              link_params: {
                href: v1_cash_transaction_path(cash_transaction),
          ...
          if cash_transaction.card_payment?
            ...
            Link(
              href: v1_card_transactions_path(user_card_id: cash_transaction.user_card_id, default_year:, active_month_years:, format: :turbo_stream),
              variant: :outline,
