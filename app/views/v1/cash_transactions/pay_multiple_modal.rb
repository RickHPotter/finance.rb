...
class Views::V1::CashTransactions::PayMultipleModal < Views::Base
  ...
  def view_template
    div(
      ...
      div(class: "bg-white p-6 rounded-lg shadow-lg") do
        ...
        form_with(model: CashInstallment.new, url: pay_multiple_v1_cash_installments_path(ids: cash_installments.pluck(:id))) do |form|
