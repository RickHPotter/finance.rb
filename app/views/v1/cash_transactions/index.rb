...
class Views::V1::CashTransactions::Index < Views::Base
  include Phlex::Rails::Helpers::LinkTo
  include Views::V1::CashTransactions
          ...
          turbo_frame_tag :cash_transactions do
            div class: "min-h-screen", data: { controller: "datatable" } do
              div class: "mb-8 flex sm:flex-row gap-4 items-start sm:items-center justify-between bg-white p-4 rounded-lg shadow-sm" do
                render IndexSearchForm.new(url: v1_cash_transactions_path, index_context:, mobile:)
              end
            ...
            link_to(
              new_v1_cash_transaction_path(format: :turbo_stream),
