...
class Views::V1::CashTransactions::MonthYear < Views::Base
      ...
      fieldset(class: "grid grid-cols-1 border border-slate-200 rounded-lg px-2 mb-4") do
        div(class: "pb-2 pt-6 text-slate-800 flex gap-2 relative") do
          ...
          if cash_installments.any? && cash_installments.none?(&:paid?)
            render Views::V1::CashTransactions::PayMultipleModal.new(cash_installments:)
            render Views::V1::CashTransactions::TransferMultipleModal.new(cash_installments:)
        ...
        if cash_installments.present? || budgets.present?
          render Views::V1::CashInstallments::Index.new(mobile:, cash_installments:)
          render Views::V1::Budgets::Budgets.new(mobile:, budgets:, show_rows_not_found: false)
        else
