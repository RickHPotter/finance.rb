...
class Views::V1::Balances::Index < Views::Base
            ...
            div(
              ...
              div(class: "bg-white shadow-lg rounded-lg p-2",
                  data: {
                    ...
                    monthly_balance_url_value: cash_balance_json_v1_balances_path(format: :json),
                    monthly_balance_url_two_value: transaction_balance_json_v1_balances_path(format: :json)
                  }) do
