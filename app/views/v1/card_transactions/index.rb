...
class Views::V1::CardTransactions::Index < Views::Base
  include Views::V1::CardTransactions
  ...
  def view_template
    @url = search ? search_v1_card_transactions_path : v1_card_transactions_path
      ...
      div class: "w-full" do
        div class: "min-w-full" do
          turbo_frame_tag :card_transactions do
            ...
            link_to(
              new_v1_card_transaction_path(user_card_id: user_card&.id, format: :turbo_stream),
