...
class Views::V1::CardTransactions::Form < Views::Base # rubocop:disable Metrics/ClassLength
      ...
      form_with(
        ...
        div(class: "grid grid-cols-1 lg:flex items-center justify-center gap-2 mx-auto") do
          ...
          if card_transaction.can_be_destroyed?
            Button(
              link: duplicate_v1_card_transaction_path(card_transaction),
            ...
            LinkWithConfirmation(
              ...
              link_params: {
                href: v1_card_transaction_path(card_transaction),
