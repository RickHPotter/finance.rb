...
class Views::V1::Budgets::IndexSearchForm < Views::Base
  ...
  def build_month_year_selector
    div class: "mb-6 flex gap-4 flex-wrap" do
      render Views::Shared::MonthYearSelector.new(current_user:, default_year:, years:, active_month_years:) do
        link_to new_v1_budget_path(format: :turbo_stream),
