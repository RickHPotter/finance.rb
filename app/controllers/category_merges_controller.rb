...
class CategoryMergesController < ApplicationController
  include TabsConcern
  ...
  def result_message(result)
    key = result.applied? ? "category_merges.applied" : "category_merges.reasons.#{result.reason_code}"
    I18n.t(key, default: I18n.t("category_merges.reasons.unexpected_failure"))
  end
