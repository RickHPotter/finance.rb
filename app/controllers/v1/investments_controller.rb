...
class V1::InvestmentsController < V1::ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.html do
        render Views::V1::Investments::Index.new(index_context: @index_context)
      end
  ...
  def month_year
    ...
    render Views::V1::Investments::MonthYear.new(mobile: @mobile, month_year:, month_year_str:, investments:, current_user:)
  end
  ...
  def new
    ...
    respond_to do |format|
      format.html { render Views::V1::Investments::New.new(current_user:, investment: @investment) }
      format.turbo_stream do
        set_tabs(active_menu: :cash, active_sub_menu: :investment)
      end
    end
  ...
  def edit
    respond_to do |format|
      format.html { render Views::V1::Investments::Edit.new(current_user:, investment: @investment) }
      format.turbo_stream do
        set_tabs(active_menu: :cash, active_sub_menu: :investment)
      end
    end
