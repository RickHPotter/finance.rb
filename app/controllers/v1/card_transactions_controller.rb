...
class V1::CardTransactionsController < V1::ApplicationController # rubocop:disable Metrics/ClassLength
  ...
  def index
    ...
    respond_to do |format|
      format.html do
        render Views::V1::CardTransactions::Index.new(index_context: @index_context, mobile: @mobile)
      end
  ...
  def search
    ...
    respond_to do |format|
      format.html do
        render Views::V1::CardTransactions::Index.new(index_context: @index_context, search: true, mobile: @mobile)
      end
  ...
  def month_year
    ...
    render Views::V1::CardTransactions::MonthYear.new(mobile:, month_year:, user_card_id:, card_installments:)
  end
  ...
  def new
    ...
    respond_to do |format|
      format.html { render Views::V1::CardTransactions::New.new(current_user:, card_transaction: @card_transaction) }
      format.turbo_stream do
  ...
  def edit
    ...
    respond_to do |format|
      format.html { render Views::V1::CardTransactions::Edit.new(current_user:, card_transaction: @card_transaction) }
      format.turbo_stream do
        set_tabs(active_menu: :card, active_sub_menu: @card_transaction&.user_card&.user_card_name)
      end
    end
  ...
  def duplicate
    ...
    render Views::V1::CardTransactions::New.new(current_user:, card_transaction: @card_transaction)
  end
      ...
      respond_to do |format|
        format.turbo_stream do
          ...
          render turbo_stream: [
            ...
            turbo_stream.update(:tabs, partial: "shared/v1/tabs")
          ]
        end
      end
    else
