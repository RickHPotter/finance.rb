...
class V1::BudgetsController < V1::ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.html do
        render Views::V1::Budgets::Index.new(index_context: @index_context)
      end
  ...
  def month_year
    ...
    render Views::V1::Budgets::MonthYear.new(mobile: @mobile, month_year:, month_year_str:, budgets:)
  end
  ...
  def new
    ...
    respond_to do |format|
      format.html { render Views::V1::Budgets::New.new(current_user:, budget: @budget) }
      format.turbo_stream do
        set_tabs(active_menu: :cash, active_sub_menu: :budget)
      end
    end
  ...
  def edit
    respond_to do |format|
      format.html { render Views::V1::Budgets::Edit.new(current_user:, budget: @budget) }
      format.turbo_stream do
        set_tabs(active_menu: :cash, active_sub_menu: :budget)
      end
    end
