# Scheduling is handled externally by system cron invoking Rake tasks in
# lib/tasks/scheduled.rake. Keeping this initializer as a no-op prevents
# in-process schedulers from running in each web process.
