...
- [SUMMARY](#summary)
  ...
  - [SPRINT PLANNING I: __GAARA__](#sprint-planning-i-gaara)
...
### __GAARA__-01/be-01: Finish late Model Specs

- Subtasks:
  - ✅ Create Models Specs for `CardTransaction` and `Installment`.

### __GAARA__-02/be-02: Create Models that revolve around `MoneyTransaction`
...
- Extra:
  - ✅ Created Concerns for `MonthYear` and callbacks for `(Starting)Price` and `Active`.

### __GAARA__-03/be-03: Implement 'buy now, pay later' system
...
- Extra:
  ...
  - ✅ Adjusted #set_month_year to comply with `current_[closing/due]_date` of `UserCard`.
  - ✅ Refined `Installment` Spec based on how the `Investment` spec was created.
  - ✅ Standardised the specs blocks and documentation.

### __GAARA__-04/app-01: Update stack and add `Docker`
...
### __GAARA__-05/be-04: Create `EntityTransaction` Model; `Installments` in `MoneyTransaction`
...
### __GAARA__-06/be-05: Create `Exchange` Model
...
### __GAARA__-07/be-06: Refine `Exchange` Model
...
### __GAARA__-08/be-07: Refine Seeds and fix possible bugs found at this stage
...
### __GAARA__-09/fe-01: Refine `AutocompleteSelect`
...
### __GAARA__-10/fe-02: Create a Component that allows to select multiple options
...
### __GAARA__-11/fe-03: Refine `TabComponent`, Create CRUD for `Category`, `Entity` and `UserCard`
...
### __GAARA__-12/fe-04: Finish the MVP
