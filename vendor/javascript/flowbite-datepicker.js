...
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
          ...
          const defaultOptions = {
            ...
            maxView: 3,
            minDate: null,
            nextArrow: '<svg class="w-4 h-4 rtl:rotate-180 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/></svg>',
            orientation: 'auto',
            pickLevel: 0,
            prevArrow: '<svg class="w-4 h-4 rtl:rotate-180 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 5H1m0 0 4 4M1 5l4-4"/></svg>',
            showDaysOfWeek: true,
            showOnClick: true,
            showOnFocus: true,
            startView: 0,
...
/* harmony default export */ var options_defaultOptions = (defaultOptions);
  ...
  <div class="datepicker-picker inline-block rounded-lg bg-white shadow-lg p-3">
    ...
    <div class="datepicker-footer">
      <div class="datepicker-controls flex space-x-2 rtl:space-x-reverse mt-2">
        ...
        <button type="button" class="%buttonClass% clear-btn text-gray-900 border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-blue-300 focus:!ring-primary-300 font-medium rounded-lg text-sm px-5 py-2 text-center w-1/2"></button>
      </div>
    </div>
  </div>
</div>`);
          ...
          class DaysView extends View {
            ...
            render() {
              ...
              Array.from(this.grid.children).forEach((el, index) => {
                ...
                if (this.selected.includes(current)) {
                  classList.add('selected', 'bg-blue-700', '!bg-primary-700', 'text-white');
            ...
            refresh() {
              ...
              this.grid
                ...
                .forEach((el) => {
                  el.classList.remove('range', 'range-start', 'range-end', 'selected', 'bg-blue-700', '!bg-primary-700', 'text-white', 'focused');
          ...
          class YearsView extends View {
            ...
            refresh() {
              ...
              this.grid
                .querySelectorAll('.range, .range-start, .range-end, .selected, .focused')
                .forEach((el) => {
                  el.classList.remove('range', 'range-start', 'range-end', 'selected', 'bg-blue-700', '!bg-primary-700', 'text-white', 'dark!bg-primary-600', 'focused');
                });
              Array.from(this.grid.children).forEach((el) => {
