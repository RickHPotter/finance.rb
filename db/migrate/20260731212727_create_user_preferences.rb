...
class CreateUserPreferences < ActiveRecord::Migration[8.1]
  def change
    create_table :user_preferences do |t|
      ...
      t.string :row_color_mode, default: "row_coloured", null: false
      ...
      t.string :default_cash_transaction_date_order, default: "cash_installment_date", null: false
    ...
    up_only do
      User.find_each do |user|
        UserPreference.create!(user_id: user.id, active_context_id: user.contexts.first&.id)
      end
    end
  end
end
